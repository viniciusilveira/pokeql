defmodule Pokeql.PokemonContext do
  ...
  @doc "Lists all Pokemon with species preloaded."
  @spec list_pokemons_with_species() :: [Pokemon.t()]
  def list_pokemons_with_species do
    list_pokemons(preload: [:species])
  end

  @doc "Gets Pokemon by generation name. Alias for list_pokemons_by_generation/1."
  @spec get_pokemons_by_generation(String.t()) :: [Pokemon.t()]
  def get_pokemons_by_generation(generation_name) do
    list_pokemons_by_generation(generation_name)
  end
