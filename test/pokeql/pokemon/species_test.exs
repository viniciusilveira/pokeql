defmodule Pokeql.Pokemon.SpeciesTest do
  ...
  describe "changeset/2" do
    ...
    test "validates capture_rate is between 3 and 255" do
      changeset = Species.changeset(%Species{}, %{@valid_attrs | capture_rate: 2})
      refute changeset.valid?
      assert "must be between 3 and 255" in errors_on(changeset)[:capture_rate]
